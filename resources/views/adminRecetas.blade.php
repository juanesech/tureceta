...
<div id="wrapper">
    ...
    <div class="main" id="mainHome">
        ...
        <div class="main-content">
            <div class="container-fluid">
                <!-- OVERVIEW -->
                <div class="panel panel-headline" id="medidas">
                    <div class="panel-heading">
                        <h3 class="panel-title">Administrar recetas</h3>
                    </div>
                    <div class="panel-body">
                        <div class="crear">
                            <strong>Crear receta</strong>
                            {!! Form::open(array('route' => 'adminRecetas.store','method'=>'POST')) !!}
                            {!! Form::text('nombre', null, array('placeholder' => 'Nombre','class' => 'form-control'))!!}
                                <br>
                             {!!Form::textarea('instrucciones', null, array('placeholder' => 'Instrucciones','class' => 'form-control')),
                        ...
                        <table class="table table-hover">
                            ...
                            @foreach ($recetas as $receta)
                                <tr>
                                    <td>{{ $receta->nombre}}</td>
                                    <td>
                                        <a target="_blank"  class="btn btn-success" href="{{ route('adminRecetas.show',$receta->id) }}">Ver</a>
                                        {!! Form::open(['method' => 'DELETE','route' => ['adminRecetas.destroy', $receta->id],'style'=>'display:inline']) !!}
