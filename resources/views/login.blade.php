			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo"><img id="loginHeaderLogo" src="{{ URL::asset('assets/img/letras.png') }}" alt="Klorofil Logo"></div>
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Tu mejor aliado en la cocina</h1>
							<p>Encuentra recetas que contengan ingredientesa tu elección</p>
						</div>
					</div>
