            ...
            <div class="container-fluid">
                ...
                <div class="panel panel-headline" id="ingredientes">
                    <div class="panel-heading">
                        <h3 class="panel-title">Administrar relación</h3>

                    </div>
                    <div class="panel-body">
                        <div class="crear">
                            <strong>Crear relación</strong>
                            {!! Form::open(array('route' => 'adminRecetaIngrediente.store','method'=>'POST')) !!}
                                {!! Form::select('receta_id', $recetas, null),
                                    Form::text('cantidad', null),
                                    Form::select('ingrediente_id', $ingredientes, null),
                        ...
                        <table class="table table-hover">
                            ...
                            @foreach ($recetaIngredientes as $recetaIngrediente)
                                <tr>
                                    <td>{{ $recetaIngrediente->receta_id}}</td>
                                    <td>{{ $recetaIngrediente->ingrediente_id}}</td>
                                    <td>{{ $recetaIngrediente->cantidad}}</td>
                                    <td>
                                        {!! Form::open(['method' => 'DELETE','route' => ['adminRecetaIngrediente.destroy', $recetaIngrediente->ingrediente_id, $recetaIngrediente->receta_id],'style'=>'display:inline']) !!}
