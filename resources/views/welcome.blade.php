...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="brand">
            <a href="index.html"><img src="assets/img/letras.png" alt="Klorofil Logo" class="img-responsive logo" id="tuRecetaLogo"></a>
        </div>
        <div class="container-fluid">
            ...
            <div class="navbar-btn navbar-btn-right">
                <a class="btn btn-success update-pro" href="https://www.themeineed.com/downloads/klorofil-pro-bootstrap-admin-dashboard-template/?utm_source=klorofil&utm_medium=template&utm_campaign=KlorofilPro" title="Upgrade to Premium" target="_blank"><i class="fa fa-rocket"></i> <span>UPGRADE TO PREMIUM</span></a>
            </div>
            <div id="navbar-menu">
            ...
            <div class="container-fluid">
                ...
                <div class="panel panel-headline">
                    <div class="panel-heading">
                        <h3 class="panel-title">Un mensaje cualquiera !!!</h3>
